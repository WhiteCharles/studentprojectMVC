...
namespace studentprojectMVC.Areas.Identity.Pages.Account.Manage
{
    public class DeletePersonalDataModel : PageModel
    {
        ...
        private readonly SignInManager<ApplicationUser> _signInManager;  // IdentityUser --> ApplicationUser
        private readonly ILogger<DeletePersonalDataModel> _logger;

        public DeletePersonalDataModel(
            UserManager<ApplicationUser> userManager,  // IdentityUser --> ApplicationUser
            SignInManager<ApplicationUser> signInManager,  // IdentityUser --> ApplicationUser
