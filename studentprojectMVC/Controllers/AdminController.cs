...
namespace studentprojectMVC.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        //    var claimsManagementViewModel = new ClaimsManagementViewModel { UserId = user.Id, AllClaimsList = StudentprojectMVCClaimTypes.ClaimsList };
        ...
        //[HttpPost]
        //public async Task<IActionResult> ManageUserClaims(ClaimsManagementViewModel claimsManagementViewModel)
        //{
        //    var user = await _userManager.FindByIdAsync(claimsManagementViewModel.UserId);
