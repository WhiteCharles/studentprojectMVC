...
{
    public partial class ID336492_recordContext : DbContext
    {
        public ID336492_recordContext()
        {
        }

        public ID336492_recordContext(DbContextOptions<ID336492_recordContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Name=ConnectionStrings:productionDB");
            }
        }
